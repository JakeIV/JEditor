...
public class RibbonMenu extends JPanel {
	...
	public void addIcons() {
		newtab.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/newtab.png"))));
		open.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/open.png"))));
		save.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/save.png"))));
		saveas.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/saveas.png"))));
		close.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/close.png"))));
		closeall.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/closeall.png"))));
		undo.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/undo.png"))));
		redo.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/redo.png"))));
		help.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("images/help.png"))));
		...
		saveas.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				EventQueue.invokeLater(new Runnable() {
					...
					public void run() {
						JEditor.frame
								.setTitle("JEditor - " + CTabbedPane.getInstance().getPanel().getCurrentFilePath());
						CTabbedPane.getInstance().setTitleAt(CTabbedPane.getInstance().getSelectedIndex(),
								new File(CTabbedPane.getInstance().getPanel().getCurrentFilePath()).getName());
						CTabbedPane.getInstance().setToolTipTextAt(CTabbedPane.getInstance().getSelectedIndex(),
								CTabbedPane.getInstance().getPanel().getCurrentFilePath());
						EditorUtilities.updateInfo(CTabbedPane.getInstance().getPanel().getCurrentFilePath(),
								CTabbedPane.getInstance());
						FileViewer.getInstance().addToTree(
								CTabbedPane.getInstance().getTitleAt(CTabbedPane.getInstance().getSelectedIndex()),
								CTabbedPane.getInstance().getPanel().unique);
